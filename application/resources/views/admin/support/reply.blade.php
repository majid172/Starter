                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-10">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-3">
                                            <button type="button" class="btn btn-primary extraTicketAttachment ms-0"><i class="fa fa-plus"></i></button>
                                        </div>
                                        <div class="col-12">
                                            <div id="fileUploadsContainer" ></div>
                                        </div>
                                ...
                                <div class="col-3 ">
                                    <button class="btn btn-primary mt-4 " type="submit" name="replayTicket"
                                        value="1">@lang('Reply')
                                    </button>
                                </div>
                            </div>
