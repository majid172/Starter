                        ...
                        <div class="row mt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <div class="form-group">
                                                    <label>@lang('Dollar Rate')</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text bg-primary text-light">1 {{ __($general->cur_text)
                                                            }}
                                                            =
                                                        </span>
                                                        <input type="text" class="form-control" name="rate"
                                                            value="{{ getAmount($method->singleCurrency->rate) }}" required />
                                                        <span class="currency_symbol input-group-text bg-primary text-light"></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="card ">
                                            ...
                                            <div class="card-body">
                                                <h5 class="text-primary">@lang('Transaction Charge')</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="card  mb-2">
                                            ...
                                            <div class="card-body">
                                                <h5 class="text-primary">@lang('Limit')</h5>
                                                <div class="form-group">
                                                    <label>@lang('Min')</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="min_limit"
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="card border my-2">
                                    ...
                                    <div class="card-body">
                                        <h5 class="text-primary">@lang('Special Instructions') </h5>
                                        <div class="form-group">
                                            <textarea rows="3" class="form-control trumEdit border-radius-5"
                                                name="instruction">{{ $method->description}}</textarea>
                                        </div>
