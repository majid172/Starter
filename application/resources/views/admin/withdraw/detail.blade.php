                    ...
                    <div class="card-body">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <button class="btn btn-danger ms-1 rejectBtn" data-id="{{ $withdrawal->id }}">
                ...
                <div class="card b-radius-10 overflow-hidden box-shadow1">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('After Charge')
                                <span class="fw-bold">{{ showAmount($withdrawal->after_charge ) }} {{ __($general->cur_text)
                                    }}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @lang('Rate')
        ...
        <div class="modal-content">
            ...
            <form action="{{route('admin.withdraw.reject')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <textarea name="details" class="form-control pt-3" rows="3" value="{{ old('details') }}"
                        required></textarea>
                </div>
                <div class="modal-footer">
                    <button type="submit" class="btn btn--primary btn-global">@lang('Save')</button>
