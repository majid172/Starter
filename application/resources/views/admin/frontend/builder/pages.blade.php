...
{{-- <div class="row">
    <div class="col-lg-6">
        <div class="card b-radius--10 ">
            <div class="card-header text-right">
                @lang('Main Pages') <button type="button" class="btn btn-sm btn--primary addBtn"><i class="las la-plus"></i>@lang('Add
                    New')</button>
            </div>
    ...
    <div class="col-lg-6">
        <div class="card b-radius--10 ">
            <div class="card-header text-right">
                @lang('Policy Pages') <a href="{{route('admin.frontend.sections.element',$key)}}" class="btn btn-sm btn--primary"><i
        ...
        <div class="col-lg-6 grid-margin stretch-card">
            <div class="card">
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title"> @lang('Policy Pages') 
