                                    ...
                                    <div class="thumb">
                                        <div class="avatar-preview">
                                            <div class="profilePicPreview"
                                                style="background-image: url({{getImage('assets/images/frontend/' . $key .'/'. @$data->data_values->$imgKey,@$section->element->images->$imgKey->size) }})">
                                        ...
                                        <div class="avatar-edit">
                                            ...
                                            <label for="profilePicUpload{{ $loop->index }}" class="bg--primary">{{
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="10" class="form-control" name="{{$k}}"
                                    required>{{ @$data->data_values->$k}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea rows="10" class="form-control trumEdit"
                                    name="{{$k}}">{{ @$data->data_values->$k}}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="{{ @$selectName }}" required>
                                    ...
                                    <option value="{{ $selectItemKey }}" @if(@$data->data_values->$selectName ==
                                        $selectItemKey) selected @endif>{{ __($selectOption) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('admin.frontend.sections.content', $key) }}" method="POST"
                    ...
                    <div class="form-group text-end">
                        <button type="submit" class="btn btn-primary btn-global text-left">@lang('Submit')</button>
                    </div>
                </form>
